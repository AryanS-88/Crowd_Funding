    ...
    <div className="relative">
      ...
      <div className="relative bg-opacity-75 backgroundMain">
        ...
        <div className="relative px-4 py-16 mx-auto overflow-hidden sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col itmes-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:pr-16 xl:w-7/12">
              ...
              <p className="max-w-xl mb-4 text-base text-gray-200 md:text-lg justify-items">
                Welcome to SeedVerse, the future of decentralized crowdfunding.
                a platform powered by blockchain to Raise support bold ideas
            ...
            <div className='w-full max-w-xl xl":px-8 xl-w:5/12'>
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                <h3 className="mb-4 text-xl font-semibold sm:text-center sm:mb-6 sm:text-2xl sm:">
                  Campaign
                </h3>
                <form>
                  <div className="mb-1 sm:mb-2">
                    ...
                    <input
                      ...
                      required
                      type="text"
                      className="flex-grid w-full h-12 px-mb-2 transition duration-200 bg-white border border-gray-300 rounded shadow-sm appearance-none
                  ...
                  <div className="mt-8 mb-2 sm:mb-4">
                    ...
                    <p className="text-xs text-gray-600 sm:text-sm text-center mt-10">
                      Create your Campaign to raise your funds
                    </p>
                  </div>
                </form>
              </div>
